...
def main():
    """
        ...
        выводит среднюю цену закрытия, анализирует колебания цен, рассчитывает MACD, RSI и строит графики, в том числе
        интерактивные. Также добавлена функция, которая позволяет сохранять загруженные данные об акциях в CSV файл.
        Доступен выбор стиля графиков.
    ...
    # Вызов функции для рассчёта стандартного отклонения цены закрытия акции
